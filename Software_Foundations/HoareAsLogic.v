...
Lemma wp_is_precondition: forall c Q,
  {{wp c Q}} c {{Q}}.
Proof.
  intros. intros st st'. intros. unfold wp in H0. apply H0. assumption.
Qed.
(** [] *)
...
Proof.
  intros. intros st'. intros. apply (H st st'). assumption. assumption.
Qed.
...
Proof.
  ...
  - (* IFB *)
    apply H_If.
    + apply IHc1. intros st st'. intros. destruct H0.
      apply (HT st st'). apply E_IfTrue. assumption. assumption. assumption.
    + apply IHc2. intros st st'. intros. destruct H0.
      apply (HT st st'). apply E_IfFalse. apply bassn_eval_false.
      assumption. assumption. assumption.
  - (* WHILE *)
    eapply H_Consequence.
    + apply H_While. apply IHc. intros st st'. intros. destruct H0.
Abort.
(** [] *)
